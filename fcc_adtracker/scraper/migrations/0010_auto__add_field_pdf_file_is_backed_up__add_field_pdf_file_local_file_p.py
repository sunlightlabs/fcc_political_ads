...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PDF_File.is_backed_up'
        db.add_column('scraper_pdf_file', 'is_backed_up',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PDF_File.local_file_path'
        db.add_column('scraper_pdf_file', 'local_file_path',
                      self.gf('django.db.models.fields.CharField')(max_length=511, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PDF_File.s3_full_url'
        db.add_column('scraper_pdf_file', 's3_full_url',
                      self.gf('django.db.models.fields.CharField')(max_length=600, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PDF_File.not_at_fcc'
        db.add_column('scraper_pdf_file', 'not_at_fcc',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PDF_File.missing_as_of_date'
        db.add_column('scraper_pdf_file', 'missing_as_of_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PDF_File.is_backed_up'
        db.delete_column('scraper_pdf_file', 'is_backed_up')

        # Deleting field 'PDF_File.local_file_path'
        db.delete_column('scraper_pdf_file', 'local_file_path')

        # Deleting field 'PDF_File.s3_full_url'
        db.delete_column('scraper_pdf_file', 's3_full_url')

        # Deleting field 'PDF_File.not_at_fcc'
        db.delete_column('scraper_pdf_file', 'not_at_fcc')

        # Deleting field 'PDF_File.missing_as_of_date'
        db.delete_column('scraper_pdf_file', 'missing_as_of_date')
