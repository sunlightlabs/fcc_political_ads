...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'dma_weekly.pres_buys'
        db.delete_column('scraper_dma_weekly', 'pres_buys')

        # Deleting field 'dma_weekly.house_buys'
        db.delete_column('scraper_dma_weekly', 'house_buys')

        # Deleting field 'dma_weekly.sen_buys'
        db.delete_column('scraper_dma_weekly', 'sen_buys')

        # Adding field 'dma_weekly.federal_buys'
        db.add_column('scraper_dma_weekly', 'federal_buys',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'dma_weekly.pres_buys'
        db.add_column('scraper_dma_weekly', 'pres_buys',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'dma_weekly.house_buys'
        db.add_column('scraper_dma_weekly', 'house_buys',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'dma_weekly.sen_buys'
        db.add_column('scraper_dma_weekly', 'sen_buys',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'dma_weekly.federal_buys'
        db.delete_column('scraper_dma_weekly', 'federal_buys')
    ...
    models = {
        ...
        'scraper.dma_weekly': {
            ...
            'fcc_dma_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'federal_buys': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'local_buys': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'outside_buys': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
