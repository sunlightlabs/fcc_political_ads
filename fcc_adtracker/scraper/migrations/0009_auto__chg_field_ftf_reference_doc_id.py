...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ftf_reference.doc_id'
        db.alter_column('scraper_ftf_reference', 'doc_id', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'ftf_reference.doc_id'
        db.alter_column('scraper_ftf_reference', 'doc_id', self.gf('django.db.models.fields.IntegerField')(null=True))
