...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PDF_File.underscore_url'
        db.add_column('scraper_pdf_file', 'underscore_url',
                      self.gf('django.db.models.fields.CharField')(max_length=511, null=True),
                      keep_default=False)

        # Adding field 'PDF_File.filedir_url'
        db.add_column('scraper_pdf_file', 'filedir_url',
                      self.gf('django.db.models.fields.CharField')(max_length=511, null=True),
                      keep_default=False)

        # Adding field 'PDF_File.containing_folder_path'
        db.add_column('scraper_pdf_file', 'containing_folder_path',
                      self.gf('django.db.models.fields.CharField')(max_length=511, null=True),
                      keep_default=False)

        # Adding field 'PDF_File.quickview_folder_path'
        db.add_column('scraper_pdf_file', 'quickview_folder_path',
                      self.gf('django.db.models.fields.CharField')(max_length=511, null=True),
                      keep_default=False)

        # Adding field 'PDF_File.document_title'
        db.add_column('scraper_pdf_file', 'document_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PDF_File.paths_configured'
        db.add_column('scraper_pdf_file', 'paths_configured',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PDF_File.underscore_url'
        db.delete_column('scraper_pdf_file', 'underscore_url')

        # Deleting field 'PDF_File.filedir_url'
        db.delete_column('scraper_pdf_file', 'filedir_url')

        # Deleting field 'PDF_File.containing_folder_path'
        db.delete_column('scraper_pdf_file', 'containing_folder_path')

        # Deleting field 'PDF_File.quickview_folder_path'
        db.delete_column('scraper_pdf_file', 'quickview_folder_path')

        # Deleting field 'PDF_File.document_title'
        db.delete_column('scraper_pdf_file', 'document_title')

        # Deleting field 'PDF_File.paths_configured'
        db.delete_column('scraper_pdf_file', 'paths_configured')
    ...
    models = {
        ...
        'scraper.pdf_file': {
            ...
            'alternate_id': ('django.db.models.fields.CharField', [], {'max_length': '14', 'null': 'True'}),
            ...
            'containing_folder_path': ('django.db.models.fields.CharField', [], {'max_length': '511', 'null': 'True'}),
            'dc_slug': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'dc_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'dma_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'document_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'file_id': ('django.db.models.fields.CharField', [], {'max_length': '14', 'null': 'True'}),
            'filedir_url': ('django.db.models.fields.CharField', [], {'max_length': '511', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'paths_configured': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'quickview_folder_path': ('django.db.models.fields.CharField', [], {'max_length': '511', 'null': 'True'}),
            ...
            'underscore_url': ('django.db.models.fields.CharField', [], {'max_length': '511', 'null': 'True'}),
