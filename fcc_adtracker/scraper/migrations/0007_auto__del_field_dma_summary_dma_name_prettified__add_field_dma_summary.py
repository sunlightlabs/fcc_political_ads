...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'dma_summary.dma_name_prettified'
        db.delete_column('scraper_dma_summary', 'dma_name_prettified')

        # Adding field 'dma_summary.dma_name'
        db.add_column('scraper_dma_summary', 'dma_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'dma_summary.fcc_dma_name'
        db.add_column('scraper_dma_summary', 'fcc_dma_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'dma_summary.rank1011'
        db.add_column('scraper_dma_summary', 'rank1011',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'dma_summary.rank1112'
        db.add_column('scraper_dma_summary', 'rank1112',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'dma_summary.dma_name_prettified'
        db.add_column('scraper_dma_summary', 'dma_name_prettified',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'dma_summary.dma_name'
        db.delete_column('scraper_dma_summary', 'dma_name')

        # Deleting field 'dma_summary.fcc_dma_name'
        db.delete_column('scraper_dma_summary', 'fcc_dma_name')

        # Deleting field 'dma_summary.rank1011'
        db.delete_column('scraper_dma_summary', 'rank1011')

        # Deleting field 'dma_summary.rank1112'
        db.delete_column('scraper_dma_summary', 'rank1112')
