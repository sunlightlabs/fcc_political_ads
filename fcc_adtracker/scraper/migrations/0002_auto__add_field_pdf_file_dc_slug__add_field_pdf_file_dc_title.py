...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PDF_File.dc_slug'
        db.add_column('scraper_pdf_file', 'dc_slug',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PDF_File.dc_title'
        db.add_column('scraper_pdf_file', 'dc_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PDF_File.dc_slug'
        db.delete_column('scraper_pdf_file', 'dc_slug')

        # Deleting field 'PDF_File.dc_title'
        db.delete_column('scraper_pdf_file', 'dc_title')
