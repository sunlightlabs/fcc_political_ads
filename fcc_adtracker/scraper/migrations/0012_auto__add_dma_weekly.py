...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'dma_weekly'
        db.create_table('scraper_dma_weekly', (
            ...
            ('cycle_week_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('dma_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('dma_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('fcc_dma_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal('scraper', ['dma_weekly'])


    def backwards(self, orm):
        # Deleting model 'dma_weekly'
        db.delete_table('scraper_dma_weekly')
