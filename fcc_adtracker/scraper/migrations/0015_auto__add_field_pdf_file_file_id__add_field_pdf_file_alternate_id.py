...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PDF_File.file_id'
        db.add_column('scraper_pdf_file', 'file_id',
                      self.gf('django.db.models.fields.CharField')(max_length=14, null=True),
                      keep_default=False)

        # Adding field 'PDF_File.alternate_id'
        db.add_column('scraper_pdf_file', 'alternate_id',
                      self.gf('django.db.models.fields.CharField')(max_length=14, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PDF_File.file_id'
        db.delete_column('scraper_pdf_file', 'file_id')

        # Deleting field 'PDF_File.alternate_id'
        db.delete_column('scraper_pdf_file', 'alternate_id')
