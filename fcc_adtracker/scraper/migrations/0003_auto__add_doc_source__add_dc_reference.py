...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'doc_source'
        db.create_table('scraper_doc_source', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('project_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('project_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('use_html', self.gf('django.db.models.fields.BooleanField')(default=False, max_length=255)),
            ('raw_html', self.gf('django.db.models.fields.TextField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('scraper', ['doc_source'])

        # Adding model 'dc_reference'
        db.create_table('scraper_dc_reference', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dc_slug', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('dc_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scraper.doc_source'], null=True)),
        ))
        db.send_create_signal('scraper', ['dc_reference'])


    def backwards(self, orm):
        # Deleting model 'doc_source'
        db.delete_table('scraper_doc_source')

        # Deleting model 'dc_reference'
        db.delete_table('scraper_dc_reference')
