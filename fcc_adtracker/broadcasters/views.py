...
def state_broadcaster_list(request, state_id):
    ...
    if state_name:
        ...
        return render(request, 'broadcasters/broadcaster_list.html', {'broadcaster_list': broadcaster_list, 'state_name': state_name, 'state_geocenter': state_geocenter})
    else:
...
def broadcaster_detail(request, callsign):
    ...
    try:
        ...
        return render(request, 'broadcasters/broadcaster_detail.html', {'obj': obj, 'obj_json': obj_json, 'state_geocenter': state_geocenter})
