...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GenericPublicDocument'
        db.create_table('fccpublicfiles_genericpublicdocument', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('documentcloud_doc', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doccloud.Document'])),
        ))
        db.send_create_signal('fccpublicfiles', ['GenericPublicDocument'])

        # Adding M2M table for field broadcasters on 'GenericPublicDocument'
        db.create_table('fccpublicfiles_genericpublicdocument_broadcasters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('genericpublicdocument', models.ForeignKey(orm['fccpublicfiles.genericpublicdocument'], null=False)),
            ('broadcaster', models.ForeignKey(orm['broadcasters.broadcaster'], null=False))
        ))
        db.create_unique('fccpublicfiles_genericpublicdocument_broadcasters', ['genericpublicdocument_id', 'broadcaster_id'])


    def backwards(self, orm):
        # Deleting model 'GenericPublicDocument'
        db.delete_table('fccpublicfiles_genericpublicdocument')

        # Removing M2M table for field broadcasters on 'GenericPublicDocument'
        db.delete_table('fccpublicfiles_genericpublicdocument_broadcasters')
