...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GenericPublicDocument.is_visible'
        db.add_column('fccpublicfiles_genericpublicdocument', 'is_visible',
    ...
    def backwards(self, orm):
        # Deleting field 'GenericPublicDocument.is_visible'
        db.delete_column('fccpublicfiles_genericpublicdocument', 'is_visible')
