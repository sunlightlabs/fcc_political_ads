...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoliticalBuy.num_spots_raw'
        db.add_column('fccpublicfiles_politicalbuy', 'num_spots_raw',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PoliticalBuy.num_spots_raw'
        db.delete_column('fccpublicfiles_politicalbuy', 'num_spots_raw')


        # Changing field 'PoliticalBuy.total_spent_raw'
        db.alter_column('fccpublicfiles_politicalbuy', 'total_spent_raw', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'fccpublicfiles.politicalbuy': {
            ...
            'num_spots_raw': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'total_spent_raw': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
