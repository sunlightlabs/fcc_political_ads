...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PublicDocument.station'
        db.delete_column('fccpublicfiles_publicdocument', 'station')


    def backwards(self, orm):
        # Adding field 'PublicDocument.station'
        db.add_column('fccpublicfiles_publicdocument', 'station',
