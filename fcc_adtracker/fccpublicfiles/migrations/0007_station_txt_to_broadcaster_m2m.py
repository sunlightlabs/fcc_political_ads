...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        document_list = orm['fccpublicfiles.PublicDocument'].objects.all()
        for document in document_list:
            callsign = document.station
            try:
                broadcaster = orm['fccpublicfiles.Broadcaster'].objects.get(callsign=callsign)
                document.broadcasters.add(broadcaster)
                document.save()
            except orm['fccpublicfiles.Broadcaster'].DoesNotExist:
                pass
