...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoliticalBuy.upload_time'
        db.add_column('fccpublicfiles_politicalbuy', 'upload_time',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoliticalBuy.upload_time'
        db.delete_column('fccpublicfiles_politicalbuy', 'upload_time')
