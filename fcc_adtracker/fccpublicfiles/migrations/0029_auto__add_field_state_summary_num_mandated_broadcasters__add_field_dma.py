...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'state_summary.num_mandated_broadcasters'
        db.add_column('fccpublicfiles_state_summary', 'num_mandated_broadcasters',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'dma_summary.num_mandated_broadcasters'
        db.add_column('fccpublicfiles_dma_summary', 'num_mandated_broadcasters',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'state_summary.num_mandated_broadcasters'
        db.delete_column('fccpublicfiles_state_summary', 'num_mandated_broadcasters')

        # Deleting field 'dma_summary.num_mandated_broadcasters'
        db.delete_column('fccpublicfiles_dma_summary', 'num_mandated_broadcasters')
