...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TV_Advertiser'
        db.create_table('fccpublicfiles_tv_advertiser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('candidate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fecdata.Candidate'], null=True)),
            ('candidate_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('primary_committee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='primary committee', null=True, to=orm['fecdata.Committee'])),
            ('committee_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('advertiser_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ad_hawk_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ie_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ftum_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('is_in_adhawk', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('num_states', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('num_recent_state', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('num_dmas', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('num_recent_dmas', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('num_broadcasters', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('num_recent_broadcasters', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('num_buys', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('num_recent_buys', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('total_amount_guess_high', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('total_amount_guess', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('total_amount_guess_low', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('recent_amount_guess_high', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('recent_amount_guess', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('recent_amount_guess_low', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('fccpublicfiles', ['TV_Advertiser'])

        # Adding M2M table for field secondary_committees on 'TV_Advertiser'
        db.create_table('fccpublicfiles_tv_advertiser_secondary_committees', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tv_advertiser', models.ForeignKey(orm['fccpublicfiles.tv_advertiser'], null=False)),
            ('committee', models.ForeignKey(orm['fecdata.committee'], null=False))
        ))
        db.create_unique('fccpublicfiles_tv_advertiser_secondary_committees', ['tv_advertiser_id', 'committee_id'])

        # Adding model 'TV_Advertiser_Alias'
        db.create_table('fccpublicfiles_tv_advertiser_alias', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fccpublicfiles.TV_Advertiser'], null=True)),
            ('advertiser_name_raw', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('advertiser_name_clean', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('fccpublicfiles', ['TV_Advertiser_Alias'])


        # Changing field 'PoliticalBuy.documentcloud_doc'
        db.alter_column('fccpublicfiles_politicalbuy', 'documentcloud_doc_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['doccloud.Document'], null=True))
        # Adding field 'Organization.related_advertiser'
        db.add_column('fccpublicfiles_organization', 'related_advertiser',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fccpublicfiles.TV_Advertiser'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TV_Advertiser'
        db.delete_table('fccpublicfiles_tv_advertiser')

        # Removing M2M table for field secondary_committees on 'TV_Advertiser'
        db.delete_table('fccpublicfiles_tv_advertiser_secondary_committees')

        # Deleting model 'TV_Advertiser_Alias'
        db.delete_table('fccpublicfiles_tv_advertiser_alias')


        # User chose to not deal with backwards NULL issues for 'PoliticalBuy.documentcloud_doc'
        raise RuntimeError("Cannot reverse this migration. 'PoliticalBuy.documentcloud_doc' and its values cannot be restored.")
        # Deleting field 'Organization.related_advertiser'
        db.delete_column('fccpublicfiles_organization', 'related_advertiser_id')
