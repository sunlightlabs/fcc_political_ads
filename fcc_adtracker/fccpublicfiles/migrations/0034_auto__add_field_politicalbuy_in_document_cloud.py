...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoliticalBuy.in_document_cloud'
        db.add_column('fccpublicfiles_politicalbuy', 'in_document_cloud',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoliticalBuy.in_document_cloud'
        db.delete_column('fccpublicfiles_politicalbuy', 'in_document_cloud')
