...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field broadcasters on 'PublicDocument'
        db.create_table('fccpublicfiles_publicdocument_broadcasters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('publicdocument', models.ForeignKey(orm['fccpublicfiles.publicdocument'], null=False)),
            ('broadcaster', models.ForeignKey(orm['fccpublicfiles.broadcaster'], null=False))
        ))
        db.create_unique('fccpublicfiles_publicdocument_broadcasters', ['publicdocument_id', 'broadcaster_id'])


    def backwards(self, orm):
        # Removing M2M table for field broadcasters on 'PublicDocument'
        db.delete_table('fccpublicfiles_publicdocument_broadcasters')
    ...
    models = {
        ...
        'fccpublicfiles.address': {
            ...
            'address_labels': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['fccpublicfiles.AddressLabel']", 'symmetrical': 'False'}),
        ...
        'fccpublicfiles.politicalbuy': {
            ...
            'contract_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'contract_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'contract_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
