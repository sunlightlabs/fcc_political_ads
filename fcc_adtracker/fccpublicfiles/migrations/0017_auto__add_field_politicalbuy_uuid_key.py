...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'PoliticalBuy.uuid_key'
        db.delete_column('fccpublicfiles_politicalbuy', 'uuid_key')
    ...
    models = {
        ...
        'fccpublicfiles.politicalbuy': {
            ...
            'uuid_key': ('django.db.models.fields.CharField', [], {'max_length': '36', 'blank': 'True'})
        },
