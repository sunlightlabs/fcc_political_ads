...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoliticalBuy.using_pp_data'
        db.add_column('fccpublicfiles_politicalbuy', 'using_pp_data',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PoliticalBuy.pp_data_ref'
        db.add_column('fccpublicfiles_politicalbuy', 'pp_data_ref',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['scraper.ftf_reference'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoliticalBuy.using_pp_data'
        db.delete_column('fccpublicfiles_politicalbuy', 'using_pp_data')

        # Deleting field 'PoliticalBuy.pp_data_ref'
        db.delete_column('fccpublicfiles_politicalbuy', 'pp_data_ref_id')
