...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        db.rename_column('fccpublicfiles_politicalbuy', 'id', 'publicdocument_ptr_id')
        db.execute('alter table fccpublicfiles_politicalbuy add foreign key (publicdocument_ptr_id) references fccpublicfiles_publicdocument')
        db.execute('drop table fccpublicfiles_politicalbuy_id_seq')
