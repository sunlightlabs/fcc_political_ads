...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('fccpublicfiles_address', 'lat',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Address.lng'
        db.add_column('fccpublicfiles_address', 'lng',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('fccpublicfiles_address', 'lat')

        # Deleting field 'Address.lng'
        db.delete_column('fccpublicfiles_address', 'lng')
