...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoliticalBuy.candidate_type'
        db.add_column('fccpublicfiles_politicalbuy', 'candidate_type',
                      self.gf('django.db.models.fields.CharField')(max_length=31, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PoliticalBuy.fcc_folder_name'
        db.add_column('fccpublicfiles_politicalbuy', 'fcc_folder_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PoliticalBuy.nielsen_dma'
        db.add_column('fccpublicfiles_politicalbuy', 'nielsen_dma',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PoliticalBuy.dma_id'
        db.add_column('fccpublicfiles_politicalbuy', 'dma_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'PoliticalBuy.community_state'
        db.add_column('fccpublicfiles_politicalbuy', 'community_state',
                      self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Organization.name'
        db.alter_column('fccpublicfiles_organization', 'name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'PoliticalBuy.candidate_type'
        db.delete_column('fccpublicfiles_politicalbuy', 'candidate_type')

        # Deleting field 'PoliticalBuy.fcc_folder_name'
        db.delete_column('fccpublicfiles_politicalbuy', 'fcc_folder_name')

        # Deleting field 'PoliticalBuy.nielsen_dma'
        db.delete_column('fccpublicfiles_politicalbuy', 'nielsen_dma')

        # Deleting field 'PoliticalBuy.dma_id'
        db.delete_column('fccpublicfiles_politicalbuy', 'dma_id')

        # Deleting field 'PoliticalBuy.community_state'
        db.delete_column('fccpublicfiles_politicalbuy', 'community_state')


        # Changing field 'Organization.name'
        db.alter_column('fccpublicfiles_organization', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
