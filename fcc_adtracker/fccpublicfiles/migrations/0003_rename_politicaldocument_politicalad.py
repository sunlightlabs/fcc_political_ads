...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('fccpublicfiles_politicaldocument', 'fccpublicfiles_politicalbuy')
        db.rename_table('fccpublicfiles_politicalad', 'fccpublicfiles_politicalspot')

    def backwards(self, orm):
        db.rename_table('fccpublicfiles_politicalbuy', 'fccpublicfiles_politicaldocument')
        db.rename_table('fccpublicfiles_politicalspot', 'fccpublicfiles_politicalad')
    ...
    models = {
        ...
        'fccpublicfiles.politicalbuy': {
            ...
            'contract_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'contract_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'contract_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'fccpublicfiles.politicalspot': {
            ...
            'airing_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'airing_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 5, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
