...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BroadcasterAddress', fields ['broadcaster', 'label', 'address']
        db.create_unique('fccpublicfiles_broadcasteraddress', ['broadcaster_id', 'label_id', 'address_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BroadcasterAddress', fields ['broadcaster', 'label', 'address']
        db.delete_unique('fccpublicfiles_broadcasteraddress', ['broadcaster_id', 'label_id', 'address_id'])
    ...
    models = {
        ...
        'fccpublicfiles.politicalbuy': {
            ...
            'contract_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'contract_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'contract_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
