...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('fccpublicfiles_publicdocument_broadcasters', 'fccpublicfiles_politicalbuy_broadcasters')
        db.rename_column('fccpublicfiles_politicalbuy_broadcasters', 'publicdocument_id', 'politicalbuy_id')
        db.alter_column('fccpublicfiles_politicalbuy_broadcasters', 'politicalbuy_id', models.ForeignKey(orm['fccpublicfiles.politicalbuy'], null=False)),

    def backwards(self, orm):
        try:
            db.alter_column('fccpublicfiles_politicalbuy_broadcasters', 'politicalbuy_id', models.ForeignKey(orm['fccpublicfiles.publicdocument'], null=False)),
            db.rename_column('fccpublicfiles_politicalbuy_broadcasters', 'politicalbuy_id', 'publicdocument_id')
            db.rename_table('fccpublicfiles_politicalbuy_broadcasters', 'fccpublicfiles_publicdocument_broadcasters')
        except orm['fccpublicfiles.publicdocument'].DoesNotExist:
            pass
    ...
    models = {
        ...
        'fccpublicfiles.politicalbuy': {
            ...
            'contract_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 21, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'contract_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'contract_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 21, 0, 0)', 'null': 'True', 'blank': 'True'}),
