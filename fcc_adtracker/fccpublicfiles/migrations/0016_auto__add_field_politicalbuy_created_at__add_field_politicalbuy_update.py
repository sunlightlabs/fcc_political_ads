...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoliticalBuy.created_at'
        db.add_column('fccpublicfiles_politicalbuy', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 9, 6, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PoliticalBuy.updated_at'
        db.add_column('fccpublicfiles_politicalbuy', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PoliticalSpot.created_at'
        db.add_column('fccpublicfiles_politicalspot', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 9, 6, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'PoliticalSpot.updated_at'
        db.add_column('fccpublicfiles_politicalspot', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoliticalBuy.created_at'
        db.delete_column('fccpublicfiles_politicalbuy', 'created_at')

        # Deleting field 'PoliticalBuy.updated_at'
        db.delete_column('fccpublicfiles_politicalbuy', 'updated_at')

        # Deleting field 'PoliticalSpot.created_at'
        db.delete_column('fccpublicfiles_politicalspot', 'created_at')

        # Deleting field 'PoliticalSpot.updated_at'
        db.delete_column('fccpublicfiles_politicalspot', 'updated_at')
