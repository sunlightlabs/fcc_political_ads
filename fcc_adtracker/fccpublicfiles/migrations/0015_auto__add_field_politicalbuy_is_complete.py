...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoliticalBuy.is_complete'
        db.add_column('fccpublicfiles_politicalbuy', 'is_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoliticalBuy.is_complete'
        db.delete_column('fccpublicfiles_politicalbuy', 'is_complete')
