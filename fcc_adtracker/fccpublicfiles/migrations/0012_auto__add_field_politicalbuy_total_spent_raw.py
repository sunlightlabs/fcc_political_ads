...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoliticalBuy.total_spent_raw'
        db.add_column('fccpublicfiles_politicalbuy', 'total_spent_raw',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoliticalBuy.total_spent_raw'
        db.delete_column('fccpublicfiles_politicalbuy', 'total_spent_raw')
