...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fccpublicfiles_broadcasteraddress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('broadcaster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fccpublicfiles.Broadcaster'])),
            ('address', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fccpublicfiles.Address'])),
            ('label', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fccpublicfiles.AddressLabel'])),
        ))
        db.send_create_signal('fccpublicfiles', ['BroadcasterAddress'])

        # Removing M2M table for field address_labels on 'Address'
        db.delete_table('fccpublicfiles_address_address_labels')

        # Removing M2M table for field addresses on 'Broadcaster'
        db.delete_table('fccpublicfiles_broadcaster_addresses')


    def backwards(self, orm):
        # Deleting model 'BroadcasterAddress'
        db.delete_table('fccpublicfiles_broadcasteraddress')

        # Adding M2M table for field address_labels on 'Address'
        db.create_table('fccpublicfiles_address_address_labels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('address', models.ForeignKey(orm['fccpublicfiles.address'], null=False)),
            ('addresslabel', models.ForeignKey(orm['fccpublicfiles.addresslabel'], null=False))
        ))
        db.create_unique('fccpublicfiles_address_address_labels', ['address_id', 'addresslabel_id'])

        # Adding M2M table for field addresses on 'Broadcaster'
        db.create_table('fccpublicfiles_broadcaster_addresses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('broadcaster', models.ForeignKey(orm['fccpublicfiles.broadcaster'], null=False)),
            ('address', models.ForeignKey(orm['fccpublicfiles.address'], null=False))
        ))
        db.create_unique('fccpublicfiles_broadcaster_addresses', ['broadcaster_id', 'address_id'])
    ...
    models = {
        ...
        'fccpublicfiles.addresslabel': {
            'Meta': {'object_name': 'AddressLabel'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'})
        },
        'fccpublicfiles.broadcaster': {
            'Meta': {'ordering': "('community_state', 'community_city', 'callsign')", 'object_name': 'Broadcaster'},
            'addresses': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['fccpublicfiles.Address']", 'null': 'True', 'through': "orm['fccpublicfiles.BroadcasterAddress']", 'blank': 'True'}),
        ...
        'fccpublicfiles.broadcasteraddress': {
            'Meta': {'object_name': 'BroadcasterAddress'},
            'address': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fccpublicfiles.Address']"}),
            'broadcaster': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fccpublicfiles.Broadcaster']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fccpublicfiles.AddressLabel']"})
        },
        'fccpublicfiles.organization': {
            'Meta': {'ordering': "('name',)", 'object_name': 'Organization'},
            'addresses': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['fccpublicfiles.Address']", 'null': 'True', 'blank': 'True'}),
        ...
        'fccpublicfiles.politicalbuy': {
            ...
            'contract_end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 13, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'contract_number': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'contract_start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 8, 13, 0, 0)', 'null': 'True', 'blank': 'True'}),
        ...
        'fccpublicfiles.publicdocument': {
            ...
            'broadcasters': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['fccpublicfiles.Broadcaster']", 'symmetrical': 'False'}),
