...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoliticalBuy.is_invoice'
        db.add_column('fccpublicfiles_politicalbuy', 'is_invoice',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoliticalBuy.is_invoice'
        db.delete_column('fccpublicfiles_politicalbuy', 'is_invoice')
