...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fccpublicfiles_state_summary', (
        ...
        db.send_create_signal('fccpublicfiles', ['state_summary'])

        # Adding model 'dma_summary'
        db.create_table('fccpublicfiles_dma_summary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('rank1011', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('rank1112', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('num_broadcasters', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('tot_buys', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('pres_buys', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('sen_buys', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('fccpublicfiles', ['dma_summary'])


    def backwards(self, orm):
        # Deleting model 'state_summary'
        db.delete_table('fccpublicfiles_state_summary')

        # Deleting model 'dma_summary'
        db.delete_table('fccpublicfiles_dma_summary')
