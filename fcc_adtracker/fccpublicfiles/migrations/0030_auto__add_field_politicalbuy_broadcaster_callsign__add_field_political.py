...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PoliticalBuy.broadcaster_callsign'
        db.add_column('fccpublicfiles_politicalbuy', 'broadcaster_callsign',
                      self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PoliticalBuy.advertiser_display_name'
        db.add_column('fccpublicfiles_politicalbuy', 'advertiser_display_name',
                      self.gf('django.db.models.fields.CharField')(max_length=211, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PoliticalBuy.broadcaster_callsign'
        db.delete_column('fccpublicfiles_politicalbuy', 'broadcaster_callsign')

        # Deleting field 'PoliticalBuy.advertiser_display_name'
        db.delete_column('fccpublicfiles_politicalbuy', 'advertiser_display_name')
