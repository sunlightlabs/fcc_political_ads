...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TV_Advertiser.is_displayed'
        db.add_column('fccpublicfiles_tv_advertiser', 'is_displayed',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TV_Advertiser.is_displayed'
        db.delete_column('fccpublicfiles_tv_advertiser', 'is_displayed')
