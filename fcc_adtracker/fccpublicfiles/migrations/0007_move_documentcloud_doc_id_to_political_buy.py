...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute('''update fccpublicfiles_politicalbuy as pb
            set documentcloud_doc_id = pd.documentcloud_doc_id
            from fccpublicfiles_publicdocument pd
            where pb.publicdocument_ptr_id = pd.id''')
