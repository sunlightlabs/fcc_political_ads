...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column('fccpublicfiles_politicalbuy', 'documentcloud_doc', models.ForeignKey(Document, null=True))

    def backwards(self, orm):
        db.delete_column('fccpublicfiles_politicalbuy', 'documentcloud_doc_id')
