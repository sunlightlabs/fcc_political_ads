...
class PoliticalDocument(PublicDocument):
    """A subset of PublicFile, the PoliticalFile records requests to purchase air time for political ads"""
...
class PoliticalAd(models.Model):
    """Information particular to a political broadcast purchase (e.g., a candidate ad)"""
    document = models.ForeignKey(PoliticalDocument, verbose_name="Political Document")
