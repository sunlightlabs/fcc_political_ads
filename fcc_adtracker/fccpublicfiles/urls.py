...
from feeds import MarketFeed, StateFeed
...
urlpatterns = patterns('',
    ...
    url(r'^political-files/recent/dmas/$', 'fccpublicfiles.views.current_dma_weekly', name='recent_dma_fcc_list'),
    url(r'^political-files/weekly/(?P<week_number>\d+)/$', 'fccpublicfiles.views.weekly_dma_list', name='weekly_dma_list'),
#    url(r'^political-files/stations/$', 'fccpublicfiles.views.station_fcc_list', name='station_fcc_list'),
    ...
    url(r'^political-files/feeds/state/(?P<state_abbreviation>\w\w)/$', StateFeed()),
