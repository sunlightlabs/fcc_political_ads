...
def home_view(request):
    top_recent_sen_buys = dma_summary.objects.filter(recent_sen_buys__isnull=False).order_by('-recent_sen_buys')[:TOP_THINGS_LIMIT]
    ...
    resp_obj = {
        ...
        'top_recent_sen_buys': top_recent_sen_buys,
