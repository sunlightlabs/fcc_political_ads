...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute_many("update locations_address set is_visible = 't'; update locations_addresslabel set is_visible = 't';")

    def backwards(self, orm):
        "Write your backwards methods here."
        raise RuntimeError("Cannot reverse this migration (don't work, it's ok).")
