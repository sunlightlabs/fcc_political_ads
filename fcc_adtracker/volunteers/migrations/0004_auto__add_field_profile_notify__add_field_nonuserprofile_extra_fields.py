...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.notify'
        db.add_column('volunteers_profile', 'notify',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NonUserProfile.extra_fields'
        db.add_column('volunteers_nonuserprofile', 'extra_fields',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.notify'
        db.delete_column('volunteers_profile', 'notify')

        # Deleting field 'NonUserProfile.extra_fields'
        db.delete_column('volunteers_nonuserprofile', 'extra_fields')
    ...
    models = {
        ...
        'volunteers.nonuserprofile': {
            ...
            'extra_fields': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
