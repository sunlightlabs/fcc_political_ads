// var pa_stations_kml = 'https://www.google.com/fusiontables/exporttable?query=select+col7%3E%3E0+from+3475735+&o=kmllink&g=col7%3E%3E0'
...
jQuery(document).ready(function() {
    ...
    $.getJSON(pa_stations_file, function(data) {
        ...
        $.each(data['features'], function(key, val) {
            ...
            features.push(val);
            $("#locations ul").append("<li><h2>" + val['properties']['tv_station'] + "</h2><p>" + val['properties']['combined_address_studio'] + "</p></li>");
          });
    });
        ...
        if (status == google.maps.DistanceMatrixStatus.OK) {
            ...
            for (var i = 0; i < origins.length; i++) {
                ...
                for (var j = 0; j < results.length; j++) {
                    ...
                    if (console) {
                        console.log(to + ' ' + element.distance.value/amile + 'mi ' + duration);
                    };
                }
            }
        }
